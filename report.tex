...
Prior work regarding continuous integration has focused on operational and integrational aspects of using continuous integration within software development processes. This paper examines the applicability of 
using Peter Pirolli and Stuart Card's \textit{notional model of sensemaking}\cite{pirolli:sensemaking} as a lens to examine the interaction of continuous integration upon the previously observed sensemaking model of software development.
%%%%%%
